...
double kinetic,kinetic0,potential,potential0,lx,ly,lz,mult,dt,density,pressure,vir_sum,v_max,v_range,temperature;
vector<int> x_vel;
...
void energy_data()
{
    printf("%d %.4f %.4f %.4f %.4f\n",counter,kinetic,potential,potential+kinetic,temperature);
}
